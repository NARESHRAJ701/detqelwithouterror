    ...
    <section id="about" className="py-24 px-4 sm:px-8 bg-canvas dark:bg-canvas-dark border-b-2 border-ink">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-16 pb-6 border-b-2 border-ink gap-4">
          ...
          <span className="font-handwriting text-2xl text-ink dark:text-gray-200 font-bold rotate-[-2deg]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-20 items-start">
          ...
          <motion.div
            ...
            className="lg:col-span-7 space-y-6 text-ink dark:text-gray-200 text-lg sm:text-xl leading-relaxed"
          >
            <p className="font-sans font-semibold text-ink dark:text-white text-2xl sm:text-3xl leading-snug">
              I bridges the gap between high-end digital design and bulletproof technical execution.
            </p>
            <p className="text-ink dark:text-gray-200 font-medium">
            ...
            <p className="font-mono text-sm bg-white dark:bg-canvas-dark-paper text-ink dark:text-gray-200 p-4 rounded-xs border-2 border-ink shadow-brutalist">
            ...
            {stats.map((stat, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="font-mono text-[10px] sm:text-xs text-ink dark:text-gray-300 uppercase font-bold tracking-wider">
                    {stat.label}
                  </div>
                </div>
              );
