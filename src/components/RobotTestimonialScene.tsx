          ...
          >
            ...
            >
              ...
              <div 
                ...
                style={{ background: 'linear-gradient(180deg, #E0FF00 0%, #B2E600 100%)' }}
              >
              ...
              >
                ...
                <div className="w-24 h-24 rounded-full border-2 border-accent-acid shadow-[0_0_20px_#E0FF00,inset_0_0_10px_#E0FF00] flex flex-col items-center justify-center relative">
                ...
                <div className="absolute left-2.5 top-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-accent-acid animate-ping shadow-[0_0_8px_#E0FF00]" />
              </div>
